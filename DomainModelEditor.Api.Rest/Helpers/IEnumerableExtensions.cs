...
namespace DomainModelEditor.Api.Rest.Helpers
{
    public static class IEnumerableExtensions
    {
        ...
        */
        ...
        /// <param name="source">It should represent list of the DTO model</param>
        /// <param name="fields">Fields that passed through the query string byt the user </param>
        /// <returns></returns>
